...
from burger.views import home_page_view, AboutPageGenericView, NewsPageGenericView, shop_page_view, \
    ContactPageGenericView, NewsDetailPageGenericView, ProductDetailPageGenericView, cart, add_cart, remove_cart, \
...
urlpatterns = [
    ...
    path('contact/', ContactPageGenericView.as_view(), name='contact'),
